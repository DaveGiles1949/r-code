...
doub_time<- c(doub_time,log(2)/log(total[ii]/total[ii-1]))
...
text(15,7000, cex=0.9,col="red", paste0("'Total capacity' = ", round(gc_fit$vals$k,0) , " cases"))
text(15,6500, cex=0.9,col="red", paste0("(95% C.I. = [", round(gc_fit$vals$k-1.96*gc_fit$vals$k_se,0), " , ",round(gc_fit$vals$k+1.96*gc_fit$vals$k_se,0), "] cases)"))
...
text(27,550, cex=0.8,font=3, paste0("Produced on ", today, "  (Data up to end of Day ", n_max,")"))
