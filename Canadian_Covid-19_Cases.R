...
text(13,15000, cex=0.9, col="blue", paste0("Sample up to end of Day ", poi2))
text(13,13000, cex=0.9, col="red",paste0("Logistic doubling time = ", round(gc_fit$vals$t_gen,1), " days") )
text(13,11000, cex=0.9,col="red", paste0("Median date (point of inflection) = ", poi1))
text(13,9000, cex=0.9,col="red", paste0("Area under logistic / Area under observed = ", round(gc_fit$vals$auc_l/gc_fit$vals$auc_e,4)))
text(5,2000, cex=0.8,"(t = 0 is 1 March, 2020)")
text(40,550, cex=0.8,font=3, paste0("Produced on ", today))
...
text(10,3000, cex=0.8,"(t = 0 is 1 March, 2020)")
text(48,1000, cex=0.8,font=3, paste0("Produced on ", today ))
...
text(35,15, cex=0.8,col="blue", "Note: Reversed y-axis")
