...
text(15,4700, cex=0.9,col="red", paste0("Area under actual / Area under logistic = ", round(gc_fit$vals$auc_e/gc_fit$vals$auc_l,4)))
...
text(28.5,20000, cex=0.8,col="red", "95% Confidence Band")
