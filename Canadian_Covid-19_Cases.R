...
text(15,6400, cex=0.9, col="red", paste0("Max. doubling time = ", round(log(2)/gc_fit$vals$r,2), " days"))
text(15,5600, cex=0.9,col="red", paste0("'Total capacity' = ", round(gc_fit$vals$k,0) , " cases"))
text(15,5100, cex=0.9,col="red", paste0("(95% C.I. = [", round(gc_fit$vals$k-1.96*gc_fit$vals$k_se,0), " , ",round(gc_fit$vals$k+1.96*gc_fit$vals$k_se,0), "] cases)"))
text(15,4000, cex=0.9,col="red", paste0("Median date (point of inflection) = ", poi))
text(26,550, cex=0.8,font=3, paste0("Produced on ", today, "  (Data up to end of Day ", n_max,")"))
...
text(28.5,18500, cex=0.8,col="red", "95% Confidence Band")
