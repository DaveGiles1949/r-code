...
poi1<- round(18322+gc_fit$vals$t_mid,0)    # Day 18322 is 2020-03-01
class(poi1)<- "Date"   
...
text(15,8000, cex=0.9, col="blue", paste0("Sample up to end of Day ", poi2))
text(15,7000, cex=0.9, col="red",paste0("Logistic doubling time = ", round(gc_fit$vals$t_gen,1), " days") )
text(15,6000, cex=0.9,col="red", paste0("Median date (point of inflection) = ", poi1))
...
text(10, 10000, cex=0.9, col="blue", paste0("Sample up to end of Day ", poi2))
text(n_max, pred[n_pred], cex=0.8, col="red", paste0(poi3, " = ", pred[n_pred], " cases"))
text(5,2000, cex=0.8,"(t = 0 is 1 March, 2020)")
text(40,1000, cex=0.8,font=3, paste0("Produced on ", today ))
