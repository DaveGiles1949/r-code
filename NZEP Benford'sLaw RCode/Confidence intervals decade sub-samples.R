#Confidence Intervals for selected decade sub-samples
# Just the 1990's data for the first and second digit cases
...
# Confidence Intervals (Goodman): 95%, 90% & 99% in each case
...
ggtitle("Figure 12(a): 95% Goodman Confidence Intervals
...
ggtitle("Figure 12(b): 95% Goodman Confidence Intervals
...
ggtitle("Figure 13(a): 95% Goodman Confidence Intervals
...
ggtitle("Figure 13(b): 95% Goodman Confidence Intervals 
...
ggtitle("Figure 14(a): 95% Goodman Confidence Intervals 
...
ggtitle("Figure 14(b): 95% Goodman Confidence Intervals 
