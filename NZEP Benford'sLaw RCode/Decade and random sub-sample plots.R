...
# NOW SELECT RANDOM SAMPLES OF SIZES 1,000 AND 2,000
#######
################################################
# First Digits
##############
...
rand_c1000_2<- sample(coef_total,1000)
rand_s1000_1<- sample(se_total,1000)
rand_s1000_2<- sample(se_total,1000)
rand_t1000_1<- sample(tstat_total,1000)
rand_t1000_2<- sample(tstat_total,1000)
rand_c2000_1<- sample(coef_total,2000)
rand_c2000_2<- sample(coef_total,2000)
rand_s2000_1<- sample(se_total,2000)
rand_s2000_2<- sample(se_total,2000)
rand_t2000_1<- sample(tstat_total,2000)
rand_t2000_2<- sample(tstat_total,2000)
bfd_c1000_1<- benford(rand_c1000_1,1,sign="both")
bfd_c1000_2<- benford(rand_c1000_2,1,sign="both")
bfd_s1000_1<- benford(rand_s1000_1,1,sign="both")
bfd_s1000_2<- benford(rand_s1000_2,1,sign="both")
bfd_t1000_1<- benford(rand_t1000_1,1,sign="both")
bfd_t1000_2<- benford(rand_t1000_2,1,sign="both")
bfd_c2000_1<- benford(rand_c2000_1,1,sign="both")
bfd_c2000_2<- benford(rand_c2000_2,1,sign="both")
bfd_s2000_1<- benford(rand_s2000_1,1,sign="both")
bfd_s2000_2<- benford(rand_s2000_2,1,sign="both")
bfd_t2000_1<- benford(rand_t2000_1,1,sign="both")
bfd_t2000_2<- benford(rand_t2000_2,1,sign="both")

plot(d1,bfd_c1000_1$bfd$data.dist, col="red", xlab="1st. Digit", ylab = "Relative frequency",
pch=19, xaxp=c(1,9,8), ylim=c(0,0.35), main="Figure 11 (a): Random sample, n = 1,000
Relative Frequency of 1st. Digits of Coefficients,
Standard Errors, & t-Statistics",cex.main=0.9,cex.lab=0.9,cex.axis=0.8)
...
plot(d1,bfd_c1000_2$bfd$data.dist, col="red", xlab="1st. Digit", ylab = "Relative frequency",
pch=19, xaxp=c(1,9,8), ylim=c(0,0.35), main="Figure 11 (b): Random sample, n = 1,000
Relative Frequency of 1st. Digits of Coefficients,
Standard Errors, & t-Statistics",cex.main=0.9,cex.lab=0.9,cex.axis=0.8)
points(d1,bfd_s1000_2$bfd$data.dist, col="blue", pch=8)
points(d1,bfd_t1000_2$bfd$data.dist, col="black", pch=17)
lines(d1, bfd_c1000_2$bfd$benford.dist)
legend(6.5,0.35, legend=c("Benford's law", "coefficients","standard errors", "t-statistics"),
       col=c("black", "red", "blue","black"), lty=c(1,NA,NA,NA),pch=c(NA,19,8,17), cex=0.8)

plot(d1,bfd_c2000_1$bfd$data.dist, col="red", xlab="1st. Digit", ylab = "Relative frequency",
pch=19, xaxp=c(1,9,8), ylim=c(0,0.35), main="Figure 12 (a): Random sample, n = 2,000
Relative Frequency of 1st. Digits of Coefficients,
Standard Errors, & t-Statistics",cex.main=0.9,cex.lab=0.9,cex.axis=0.8)
...
plot(d1,bfd_c2000_2$bfd$data.dist, col="red", xlab="1st. Digit", ylab = "Relative frequency",
pch=19, xaxp=c(1,9,8), ylim=c(0,0.35), main="Figure 12 (b): Random sample, n = 2,000
Relative Frequency of 1st. Digits of Coefficients,
Standard Errors, & t-Statistics",cex.main=0.9,cex.lab=0.9,cex.axis=0.8)
points(d1,bfd_s2000_2$bfd$data.dist, col="blue", pch=8)
points(d1,bfd_t2000_2$bfd$data.dist, col="black", pch=17)
lines(d1, bfd_c2000_2$bfd$benford.dist)
legend(6.5,0.35, legend=c("Benford's law", "coefficients","standard errors", "t-statistics"),
       col=c("black", "red", "blue","black"), lty=c(1,NA,NA,NA),pch=c(NA,19,8,17), cex=0.8)
...
coef_2_ch <- str_sub(as.character(abs(rand_c1000_2)), 2, 2)    # Need to take abs. value to eliminate the "-" CHARACTERS
se_2_ch<- str_sub(as.character(rand_s1000_2), 2, 2)
tstat_2_ch<- str_sub(as.character(abs(rand_t1000_2)), 2, 2)
# Convert back to numeric
coef_2<- as.numeric(coef_2_ch)
se_2<- as.numeric(se_2_ch)
tstat_2<- as.numeric(tstat_2_ch)
...
for (ii in 1:10) {                                  
i1<- ii-1                      # run from zero to 9
coef_share1000_2[ii] <- sum(coef_2 == i1)/length(coef_2)
se_share1000_2[ii] <- sum(se_2 == i1)/length(se_2)
tstat_share1000_2[ii] <- sum(tstat_2 == i1)/length(tstat_2)
}
...
coef_2_ch <- str_sub(as.character(abs(rand_c2000_2)), 2, 2)    # Need to take abs. value to eliminate the "-" CHARACTERS
se_2_ch<- str_sub(as.character(rand_s2000_2), 2, 2)
tstat_2_ch<- str_sub(as.character(abs(rand_t2000_2)), 2, 2)
# Convert back to numeric
coef_2<- as.numeric(coef_2_ch)
se_2<- as.numeric(se_2_ch)
tstat_2<- as.numeric(tstat_2_ch)
...
for (ii in 1:10) {                                  
i1<- ii-1                      # run from zero to 9
coef_share2000_2[ii] <- sum(coef_2 == i1)/length(coef_2)
se_share2000_2[ii] <- sum(se_2 == i1)/length(se_2)
tstat_share2000_2[ii] <- sum(tstat_2 == i1)/length(tstat_2)
}
...
pch=19, xaxp=c(0,9,9), ylim=c(0.07,0.14), main="Figure 11 (b): Random sample, n = 1,000
Relative Frequency of 2nd. Digits of Coefficients,
Standard Errors, & t-Statistics",cex.main=0.9,cex.lab=0.9,cex.axis=0.8)
lines(d2, benford_2)
points(d2,se_share1000_1, col="blue", pch=8)
points(d2,tstat_share1000_1, col="black", pch=17)
legend(6.5,0.135, legend=c("Benford's law", "coefficients","standard errors", "t-statistics"),
       col=c("black", "red", "blue","black"), lty=c(1,NA,NA,NA),pch=c(NA,19,8,17), cex=0.8)

plot(d2,coef_share1000_2, col="red", xlab="2nd. Digit", ylab = "Relative frequency",
pch=19, xaxp=c(0,9,9), ylim=c(0.07,0.14), main="Figure 13 (b): Random sample, n = 1,000
Relative Frequency of 2nd. Digits of Coefficients,
Standard Errors, & t-Statistics",cex.main=0.9,cex.lab=0.9,cex.axis=0.8)
lines(d2, benford_2)
points(d2,se_share1000_2, col="blue", pch=8)
points(d2,tstat_share1000_2, col="black", pch=17)
legend(6.5,0.135, legend=c("Benford's law", "coefficients","standard errors", "t-statistics"),
       col=c("black", "red", "blue","black"), lty=c(1,NA,NA,NA),pch=c(NA,19,8,17), cex=0.8)

plot(d2,coef_share2000_1, col="red", xlab="2nd. Digit", ylab = "Relative frequency",
pch=19, xaxp=c(0,9,9), ylim=c(0.07,0.14), main="Figure 14 (a): Random sample, n = 2,000
Relative Frequency of 2nd. Digits of Coefficients,
Standard Errors, & t-Statistics",cex.main=0.9,cex.lab=0.9,cex.axis=0.8)
lines(d2, benford_2)
...
plot(d2,coef_share2000_2, col="red", xlab="2nd. Digit", ylab = "Relative frequency",
pch=19, xaxp=c(0,9,9), ylim=c(0.07,0.14), main="Figure 14 (b): Random sample, n = 2,000
Relative Frequency of 2nd. Digits of Coefficients,
Standard Errors, & t-Statistics",cex.main=0.9,cex.lab=0.9,cex.axis=0.8)
lines(d2, benford_2)
points(d2,se_share2000_2, col="blue", pch=8)
points(d2,tstat_share2000_2, col="black", pch=17)
legend(6.5,0.135, legend=c("Benford's law", "coefficients","standard errors", "t-statistics"),
       col=c("black", "red", "blue","black"), lty=c(1,NA,NA,NA),pch=c(NA,19,8,17), cex=0.8)

#####
# Change the y- axis for one case

plot(d2,coef_share1000_1, col="red", xlab="2nd. Digit", ylab = "Relative frequency",
pch=19, xaxp=c(0,9,9), ylim=c(0.0,0.35), main="Figure 11 (b): Random sample, n = 1,000
Relative Frequency of 2nd. Digits of Coefficients,
Standard Errors, & t-Statistics",cex.main=0.9,cex.lab=0.9,cex.axis=0.8)
lines(d2, benford_2)
points(d2,se_share1000_1, col="blue", pch=8)
points(d2,tstat_share1000_1, col="black", pch=17)
legend(6.5,0.3, legend=c("Benford's law", "coefficients","standard errors", "t-statistics"),
       col=c("black", "red", "blue","black"), lty=c(1,NA,NA,NA),pch=c(NA,19,8,17), cex=0.8)