...
graph_c1<- ggplot(df1, aes(x=d1, y=p))+
ggtitle("Figure 15(a): 95% Goodman Confidence Intervals
for Coefficient 1st. Digits") +
  xlab("1st. Digit") + ylab("Relative Frequency")+
theme(plot.title.position = 'plot', 
      plot.title = element_text(hjust = 0.5))+
...
ggtitle("Figure 15(b): 95% Goodman Confidence Intervals
...
ggtitle("Figure 16(a): 95% Goodman Confidence Intervals
...
ggtitle("Figure 16(b): 95% Goodman Confidence Intervals 
...
ggtitle("Figure 17(a): 95% Goodman Confidence Intervals 
...
ggtitle("Figure 17(b): 95% Goodman Confidence Intervals 
