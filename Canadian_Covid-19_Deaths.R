...
text(10,65, cex=0.9,col="red", paste0("'Total capacity' = ", round(gc_fit$vals$k,0) , " cases"))
text(10,60, cex=0.9,col="red", paste0("(95% C.I. = [", round(gc_fit$vals$k-1.96*gc_fit$vals$k_se,0), " , ",round(gc_fit$vals$k+1.96*gc_fit$vals$k_se,0), "] cases)"))
