...
text(5,1, cex=0.8,"(t = 0 is 14 March, 2020)")
text(10,140, cex=0.9, col="red", paste0("Max. doubling time = ", round(log(2)/gc_fit$vals$r,2), " days"))
text(10,120, cex=0.9,col="red", paste0("'Total capacity' = ", round(gc_fit$vals$k,0) , " deaths"))
text(10,110, cex=0.9,col="red", paste0("(95% C.I. = [", round(gc_fit$vals$k-1.96*gc_fit$vals$k_se,0), " , ",round(gc_fit$vals$k+1.96*gc_fit$vals$k_se,0), "] deaths)"))
text(10,90, cex=0.9,col="red", paste0("Median date (point of inflection) = ", poi))
