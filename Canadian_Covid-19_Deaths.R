...
poi1<- round(gc_fit$vals$t_mid+18335,0)    # Day 18335 = 2020-03-14
class(poi1)<- "Date"                   
poi2<- round(18335+n_max,0)    
class(poi2)<- "Date" 
...
text(8,1, cex=0.8,"(t = 0 is 14 March, 2020)")
text(7, 200, cex=0.9, col="blue", paste0("Sample up to end of Day ", poi2))
text(7,150, cex=0.9, col="red",paste0("Estimated doubling time = ", round(gc_fit$vals$t_gen,1), " days") )
text(7,130, cex=0.9, col="red", paste0("(Current doubling time = ", round(doub_time[n_max-n_min+1],1), " days)"))
...
text(18,1, cex=0.8,font=3, paste0("Produced on ", today))

# Plot the predicted time-path for deaths, up to 1 week ahead:
poi3<- round(18335+n_pred,0)    # Day 18322 is 2020-03-14
class(poi3)<- "Date"
...
text(n_max+3, pred[n_pred], cex=0.8, col="red", paste0(poi3, " = ", pred[n_pred], " deaths"))
text(5,80, cex=0.8,"(t = 0 is 14 March, 2020)")
text(22,1, cex=0.8,font=3, paste0("Produced on ", today, "  (Data up to end of Day ", n_max,")"))
...
text(13,3.2, cex=0.8,col="red", "Note: Reversed y-axis")
...
text(18,8.5, cex=0.8,col="red", "Note: Reversed y-axis")
##########################################################
# Alternative plot
