...
poi<- round(gc_fit$vals$t_mid+18335,0)
class(poi)<- "Date"
...
text(7,110, cex=0.9,col="red", paste0("Median date (point of inflection) = ", poi))
text(7,90, cex=0.9,col="red", paste0("Area under logistic / Area under actual = ", round(gc_fit$vals$auc_l/gc_fit$vals$auc_e,4)))
text(16,1, cex=0.8,font=3, paste0("Produced on ", today, "  (Data up to end of Day ", n_max,")"))
...
text(n_max+4, pred[n_pred], cex=0.8, col="red", paste0(pred[n_pred], " deaths"))
text(5,80, cex=0.8,"(t = 0 is 1 March, 2020)")
...
#text(18,8, cex=0.8,col="blue", "Note: Reversed y-axis")
