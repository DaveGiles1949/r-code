...
y<- c()
# Alter the next line to choose one of the first 4 Data sets
x<- read.table(file = 'C:/Users/David Giles/Dropbox/Akash distribution/Applications/Data_1.txt',header = TRUE)$Weeks

# Choose either Data_5 or Data_6:
